...
Die Anforderungen des Mandanten sehen die Umsetzung eines selbstgehosteten und umfassend abgesicherten Systems mit mindestens 15 Services vor, die \glqq eine breite Palette an alltäglichen Produktivitäts- und Cloud-Diensten abbildet...\grqq. Aufgrund der umfangreichen Investitionen in Kryptowährungen liegt außerdem ein besonderer Fokus auf Sicherheit und Datenschutz. Vor diesem Hintergurnd wurden Dienste ausgewählt, die zentrale Anwendungsbereiche abdecken und gleichzeitig die Anforderungen an Datensouveränität und Kontrolle erfüllen. 
