...
\begin{itemize}
  ...
  (\texttt{tsx=off}, \texttt{tsx\_async\_abort=full,nosmt}, \texttt{mds=full,nosmt}). Kein Standard. Deaktiviert SMT (Simultaneous Multithreading) und TSX (Transactional Memory) komplett, schützt jedoch vor Exploits ähnlich zu Rebtleed. 
  \item L1TF: \texttt{l1tf=full,force}; Retbleed: \texttt{retbleed=auto,nosmt} Kein Standard. Deaktiviert SMT 
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Docker-Socket nur via Unix-Socket:} kein TCP-Listener \\
