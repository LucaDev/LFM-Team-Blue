...
\begin{itemize}
  ...
  \item TSX deaktiviert + TAA/MDS vollständig mitigiert (\texttt{tsx=off}, \texttt{tsx\_async\_abort=full,nosmt}, \texttt{mds=full,nosmt}). Kein Standard. Deaktiviert SMT (Simultaneous Multithreading) und TSX (Transactional Memory) komplett, schützt jedoch vor Exploits ähnlich zu Rebtleed. 
...
\begin{itemize}
  ...
  \item Unprivilegiertes BPF deaktiviert: \texttt{\textcolor{OliveGreen}{kernel.unprivileged\_bpf\_disabled=1, net.core.bpf\_jit\_enable=0}}, Standard unter NixOS jedoch explizit gesetzt.
...
\begin{itemize}
  ...
  \item \texttt{/tmp} gemountet mit \texttt{nosuid,nodev,noexec}. Default=nosuid,nodev. noexec für zusätzlichere Absicherung
\end{itemize}
