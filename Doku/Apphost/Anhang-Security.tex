...
\begin{itemize}
  \item \textbf{Swap verschlüsselt:} Zufälliger Schlüssel pro Boot (\texttt{randomEncryption=true}) (keine persistenten Daten im Swap. Standardmäßig nicht unter NixOS aktiviert).
