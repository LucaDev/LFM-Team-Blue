...
Velocity-Cap & unabhängiger Backstop, überlebt eine Kompromittierung des Apphosts & Signierer (Key~A \ac{VM}) & \texttt{VELOCITY\_CAP\_SATS}, \path{VELOCITY\_WINDOW\_SEC} \\
