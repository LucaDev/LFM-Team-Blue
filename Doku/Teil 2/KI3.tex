...
Der Punktabzug ergibt sich aus der Installationskette, wobei Bitcoin Core wurde nur gegen die \texttt{SHA256SUMS}-Datei desselben Download-Servers geprüft wird und die Verifikation der zugehörigen Signaturdatei außer Acht lässt. In der geheimnisfreien Testumgebung wurde dies als kleinere Lücke eingestuft.
...
\hline
\textbf{Gesamtbewertung} & & \textbf{1,45} & & \textbf{1,75} \\
\hline
