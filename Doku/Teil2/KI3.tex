...
I2 (1): Sämtliche Secrets werden im Klartext unter \path{/root/homelab-secrets} erzeugt und in \texttt{service"=credentials.txt} inklusive Benutzer/Passwort-Paaren aggregiert. 
